  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 w-72 h-72 bg-blue-500/15 rounded-full blur-3xl animate-float"
      ...
      <div className="relative z-10 w-full max-w-md animate-scale-in">
        <div className="glass rounded-3xl p-5 shadow-2xl ">
          ...
          <Button
            ...
            isLoading={loading}
            disabled={loading}
            className="w-full py-3 text-base font-semibold bg-white text-black cursor-pointer hover:text-surface-900 hover:bg-surface-100 focus:ring-white/30 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            icon={
              !loading ? (
