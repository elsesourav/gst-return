...
export async function deleteFileMetadata(
  ...
  await deleteDoc(
    doc(db, "users", userId, "clients", clientId, "files", fileId),
  );
}

// ============================================
// Session File Operations (JSON stored inline — no Firebase Storage)
// ============================================
...
export async function saveSessionFile(
  userId: string,
  clientId: string,
  file: Omit<SessionFile, "id" | "uploadedAt">,
): Promise<string> {
...
export async function deleteProcessedData(
  ...
  await deleteDoc(
    doc(db, "users", userId, "clients", clientId, "processed", processedId),
  );
}
...
export async function deleteHistoryEntry(
  ...
  await deleteDoc(
    doc(db, "users", userId, "clients", clientId, "history", historyId),
  );
}
